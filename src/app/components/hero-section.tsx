    ...
    <section id="act-hero" data-act-idx={0} className="min-h-[70vh] flex flex-col justify-center relative">
      <div className="max-w-3xl space-y-10">
        <div className="font-mono text-xs font-black text-stamp-red flex items-center gap-2 uppercase tracking-[0.3em]">
          <span className="w-1.5 h-1.5 bg-stamp-red motion-safe:animate-pulse" /> CLASSIFIED_BRIEFING // 1986 // TOP_SECRET
        </div>
        ...
        <p className="text-2xl md:text-4xl leading-snug font-medium opacity-90 max-w-2xl font-serif italic tracking-normal text-ink-black">
          Why product designers need to learn national security. A declassified dossier on the sword we pretend not to hold.
        </p>
        <div className="pt-12 flex items-center gap-8">
          <a href="#act-myth_of_morality" className="inline-flex items-center gap-6 group">
            <span className="w-20 h-20 rounded-full border-4 border-ink-black flex items-center justify-center group-hover:bg-ink-black group-hover:text-white transition-all duration-300 shadow-[6px_6px_0px_rgba(0,0,0,0.04)] active:shadow-none active:translate-x-1 active:translate-y-1">
